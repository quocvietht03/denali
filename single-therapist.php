			...
			<div class="bt-post">
						...
						<div class="bt-post--meta">
								...
								<div class="bt-post--meta-item phone">
									<a href="<?php echo esc_url('tel:' . preg_replace('/[^0-9]+/', '', $phone)); ?>">
										...
										<div class="bt-post--meta-item-content">
											<?php
											echo '<span class="bt-label">' . esc_html__('Phone:', 'denali') . '</span>';
							...
							<?php if (!empty($email)) { ?>
								<div class="bt-post--meta-item email">
									<a href="<?php echo esc_url('mailto:' . $email); ?>">
										...
										<div class="bt-post--meta-item-content">
											<?php
											echo '<span class="bt-label">' . esc_html__('Email:', 'denali') . '</span>';
							...
							<?php if (!empty($address)) { ?>
								<div class="bt-post--meta-item address">
									...
									<div class="bt-post--meta-item-content">
										<?php
										echo '<span class="bt-label">' . esc_html__('Address:', 'denali') . '</span>';
				...
				<div class="bt-post--appointment">
					<div class="bt-post--socials">
						<?php
						if (!empty($socials)) {
							echo '<span class="bt-title">' . esc_html__('Follow Me:', 'denali') . '</span>';
