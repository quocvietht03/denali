...
namespace DenaliElementorWidgets\Widgets\PricingItem;
...
class Widget_PricingItem extends Widget_Base
{
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'pricing_image',
			[
				'label' => esc_html__('Images', 'denali'),
		...
		$this->add_control(
			'pricing_svg',
			[
				'label' => esc_html__('Icon Pricing', 'denali'),
				'type' => Controls_Manager::MEDIA,
				'media_types' => ['svg'],
			]
		);
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => esc_html__('This is the heading', 'denali'),
			]
		);
		...
		$this->add_control(
			'price',
			[
				'label' => esc_html__('Price', 'denali'),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => esc_html__('$200', 'denali'),
			]
		);
		$this->add_control(
			'price_after',
			[
				'label' => esc_html__('Price After', 'denali'),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => esc_html__(' / Monthly', 'denali'),
			]
		);
		$this->add_control(
			'time',
			[
				'label' => esc_html__('Time', 'denali'),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => esc_html__('60 Mins', 'denali'),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => esc_html__('This is the info', 'denali'),
			]
		);
		$repeater->add_control(
			'list_strikethrough',
			[
				'label' => __('Enable Strikethrough', 'denali'),
		...
		$this->add_control(
			'list_info',
			[
				'label' => __('List Info', 'denali'),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'list_content' => esc_html__('90-Minute Swedish Massage', 'denali'),
						'list_strikethrough' => 'no',
					],
					[
						'list_content' => esc_html__('60-Minute Classic Facial', 'denali'),
						'list_strikethrough' => 'no',
					],
					[
						'list_content' => esc_html__('45-Minute Full Body Scrub', 'denali'),
						'list_strikethrough' => 'no',
					],
					[
						'list_content' => esc_html__('Aromatherapy Session', 'denali'),
						'list_strikethrough' => 'no',
					],
				],
		...
		$this->add_control(
			'button_text',
			[
				'label' => esc_html__('Button Text', 'denali'),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => esc_html__('Subscribe Now', 'denali'),
			]
		);
		...
		$this->add_control(
			'button_url',
			[
				'label' => esc_html__('Button Url', 'denali'),
		...
		$this->add_control(
			'button_more',
			[
				'label' => esc_html__('Button More', 'denali'),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => esc_html__('pay per session.', 'denali'),
			]
		);
		...
		$this->add_control(
			'button_more_url',
			[
				'label' => esc_html__('Button More Url', 'denali'),
				'type' => Controls_Manager::URL,
				'options' => ['url', 'is_external', 'nofollow'],
				'default' => [
					'url' => '',
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Content Image', 'denali'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __('Background Content Image', 'denali'),
		...
		$this->add_control(
			'heading_color_hover',
			[
				'label' => __('Heading Color Hover', 'denali'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Heading Typography', 'denali'),
				'default' => '',
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Price Typography', 'denali'),
				'default' => '',
		...
		$this->add_control(
			'price_after_color',
			[
				'label' => __('Price After Color', 'denali'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Price After Typography', 'denali'),
				'default' => '',
		...
		$this->add_control(
			'time_background',
			[
				'label' => __('Time Background', 'denali'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'background_content',
			[
				'label' => __('Background Content', 'denali'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => __('Border Content Width', 'denali'),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 5,
				],
		...
		$this->add_control(
			...
			[
				'label' => __('Border Content Color', 'denali'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Info Typography', 'denali'),
				'default' => '',
		...
		$this->add_control(
			...
			[
				'label' => __('Text Color Hover', 'denali'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __('Background Color Hover', 'denali'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => __('Border Width Hover', 'denali'),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 2,
				],
		...
		$this->add_control(
			...
			[
				'label' => __('Border Color Hover', 'denali'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Button Typography', 'denali'),
				'default' => '',
		...
		$this->add_control(
			'button_more_color',
			[
				'label' => __('Button More Color', 'denali'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Button More Typography', 'denali'),
				'default' => '',
