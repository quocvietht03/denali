<?php
namespace DenaliElementorWidgets\Widgets\InstagramPosts;
...
class Widget_InstagramPosts extends Widget_Base {
	...
	public function get_title() {
		return __( 'Instagram Posts', 'denali' );
	}
	...
	protected function register_content_section_controls() {
		...
		$this->add_control(
			'gallery',
			[
				'label' => esc_html__( 'Add Images', 'denali' ),
		...
		$this->add_control(
			'follow_link_text',
			[
				'label' => esc_html__( 'Follow Link Text', 'denali' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => '',
			]
		...
		$this->add_control(
			'follow_link_url',
			[
				'label' => esc_html__( 'Follow Link Url', 'denali' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => '',
			]
	...
	protected function register_style_content_section_controls() {
		...
		$this->add_control(
			'follow_link_color',
			[
				'label' => __( 'Follow Link Color', 'denali' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Follow Link Color Hover', 'denali' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Follow Link Typography', 'denali' ),
				'default' => '',
