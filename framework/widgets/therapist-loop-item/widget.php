<?php
namespace DenaliElementorWidgets\Widgets\TherapistLoopItem;
...
class Widget_TherapistLoopItem extends Widget_Base {
	...
	public function get_title() {
		return __( 'Therapist Loop Item', 'denali' );
	}
	...
	protected function register_style_section_controls() {
		...
		$this->add_control(
			'title_background',[
				'label'     => esc_html__( 'Background Title', 'denali' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			'job_background',[
				'label'     => esc_html__( 'Background Job', 'denali' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
