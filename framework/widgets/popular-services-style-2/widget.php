...
namespace DenaliElementorWidgets\Widgets\PopularServicesStyle2;
...
class Widget_PopularServicesStyle2 extends Widget_Base
{

	public function get_name()
	{
		return 'bt-popular-services-style2';
	}

	public function get_title()
	{
		return __('Popular Services Style 2', 'denali');
	}
...
?>
		<div class="bt-elwg-service-popular--style2">
			<?php
			if ($query->have_posts()) {
			?>
				<div class="bt-service-popular columns-<?php echo esc_attr($settings['columns']) ?>">
					...
					while ($query->have_posts()) : $query->the_post();
						get_template_part('framework/templates/service', 'popular1', array('image-size' => $settings['thumbnail_size']));
					endwhile;
					?>
				</div>
			<?php
