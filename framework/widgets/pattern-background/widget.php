<?php
namespace DenaliElementorWidgets\Widgets\PatternBackground;
...
class Widget_PatternBackground extends Widget_Base {
	...
	public function get_title() {
		return __( 'Pattern Background', 'denali' );
	}
