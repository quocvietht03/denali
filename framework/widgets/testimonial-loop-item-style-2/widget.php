...
namespace DenaliElementorWidgets\Widgets\TestimonialLoopItemStyle2;
...
class Widget_TestimonialLoopItemStyle2 extends Widget_Base
{
	...
	{
		return __('Testimonial Loop Item Style 2', 'denali');
	}
	...
	protected function register_style_section_controls()
	{
		...
		$this->add_control(
			'background_image',
			[
				'label' => __('Background Images', 'denali'),
		...
		$this->add_responsive_control(
			'background_opacity',
			[
				'label' => __('Background Images Opacity', 'denali'),
