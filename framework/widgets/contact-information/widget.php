<?php
namespace DenaliElementorWidgets\Widgets\ContactInformation;
...
class Widget_ContactInformation extends Widget_Base {
	...
	public function get_title() {
		return __( 'Contact Infomation', 'denali' );
	}
	...
	protected function register_content_section_controls() {
		...
		$this->add_control(
			'description',
			[
				'label' => esc_html__( 'Description', 'denali' ),
	...
	protected function register_style_content_section_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Description Typography', 'denali' ),
				'default' => '',
