<?php
namespace DenaliElementorWidgets\Widgets\SiteCopyright;
...
class Widget_SiteCopyright extends Widget_Base {
	...
	public function get_title() {
		return __( 'Site Copyright', 'denali' );
	}
	...
	protected function register_content_section_controls() {
		...
		$this->add_control(
			'custom',
			[
				'label' => esc_html__( 'Custom Copyright', 'denali' ),
