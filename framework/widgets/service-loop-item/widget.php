<?php
namespace DenaliElementorWidgets\Widgets\ServiceLoopItem;
...
class Widget_ServiceLoopItem extends Widget_Base {
	...
	public function get_title() {
		return __( 'Service Loop Item', 'denali' );
	}
	...
	protected function register_style_section_controls() {
		...
		$this->add_control(
			'background_content',[
				'label'     => esc_html__( 'Background Content', 'denali' ),
		...
		$this->add_control(
			'title_color_hover',[
				'label'     => esc_html__( 'Color Hover', 'denali' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),[
				...
				'label'    => esc_html__( 'Typography', 'denali' ),
				'default'  => '',
		...
		$this->add_control(
			'price_background',[
				'label'     => esc_html__( 'Background', 'denali' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
