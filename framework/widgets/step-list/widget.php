<?php
namespace DenaliElementorWidgets\Widgets\StepList;
...
class Widget_StepList extends Widget_Base {
	...
	protected function register_layout_section_controls() {
		...
		$this->add_control(
			'list',
			[
				'label' => __( 'List Step', 'denali' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'denali' ),
						'step_title' => __( 'This is step title 01', 'denali' ),
						'step_desc' => __( 'This is description', 'denali' ),
						'step_btn_text' => __( 'Read More', 'denali' ),
						'step_btn_link' => '#'
					],
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'denali' ),
						'step_title' => __( 'This is step title 02', 'denali' ),
						'step_desc' => __( 'This is description', 'denali' ),
						'step_btn_text' => __( 'Read More', 'denali' ),
						'step_btn_link' => '#'
					],
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'denali' ),
						'step_title' => __( 'This is step title 03', 'denali' ),
						'step_desc' => __( 'This is description', 'denali' ),
						'step_btn_text' => __( 'Read More', 'denali' ),
						'step_btn_link' => '#'
					],
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'denali' ),
						'step_title' => __( 'This is step title 04', 'denali' ),
						'step_desc' => __( 'This is description', 'denali' ),
						'step_btn_text' => __( 'Read More', 'denali' ),
						'step_btn_link' => '#'
					],
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'denali' ),
						'step_title' => __( 'This is step title 05', 'denali' ),
						'step_desc' => __( 'This is description', 'denali' ),
						'step_btn_text' => __( 'Read More', 'denali' ),
						'step_btn_link' => '#'
					],
		...
		$this->add_control(
			'show_more_button',
			[
				'label' => __( 'Show More Button', 'denali' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'denali' ),
				'label_off' => __( 'Hide', 'denali' ),
				'default' => 'yes',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Show More Text', 'denali' ),
				'type' => Controls_Manager::TEXT,
				'show_label' => true,
				'default' => __( 'More Steps', 'denali' ),
				'condition' => [
					'show_more_button!' => '',
				],
			]
    ...
    $this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Show More Button', 'denali' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_more_button!' => '',
				],
