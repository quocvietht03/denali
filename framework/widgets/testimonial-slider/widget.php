<?php
namespace DenaliElementorWidgets\Widgets\TestimonialSlider;
...
class Widget_TestimonialSlider extends Widget_Base {
	...
	public function get_title() {
		return __( 'Testimonial Slider', 'denali' );
	}
  ...
  public function get_icon() {
    ...
    $this->start_controls_section(
		...
		$this->add_control(
			'info_style',
			[
				'label' => __( 'Info Background', 'denali' ),
				'type' => Controls_Manager::HEADING,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Arrows', 'denali' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
