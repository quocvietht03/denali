<?php
function denali_register_layout_category($categories)
{
...
add_filter('block_categories_all', 'denali_register_layout_category');

function denali_acf_init()
{
    ...
    if (function_exists('acf_register_block')) {
        acf_register_block(array(
            ...
            'title'             => __('Widget - Recent Posts', 'denali'),
            'description'       => __('Widget - Recent Posts block.', 'denali'),
            'render_callback'   => 'denali_acf_block_render_callback',
            // 'enqueue_assets' => 'denali_acf_block_assets_callback',
        ...
        acf_register_block(array(
            ...
            'title'             => __('Widget - Make Appointment', 'denali'),
            'description'       => __('Widget - Make Appointment block.', 'denali'),
            'render_callback'   => 'denali_acf_block_render_callback',
            // 'enqueue_assets' => 'denali_acf_block_assets_callback',
            'category'          => 'bt-custom-block',
            'icon'              => '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z" /><path d="M19 13H5v-2h14v2z" /></svg>',
        ...
        acf_register_block(array(
            ...
            'title'             => __('Widget - Popular Category Posts', 'denali'),
            'description'       => __('Widget - Popular Category Posts block.', 'denali'),
            'render_callback'   => 'denali_acf_block_render_callback',
            // 'enqueue_assets' => 'denali_acf_block_assets_callback',
            'category'          => 'bt-custom-block',
            'icon'              => '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z" /><path d="M19 13H5v-2h14v2z" /></svg>',
        ...
        acf_register_block(array(
            ...
            'title'             => __('Widget - Instagram Posts', 'denali'),
            'description'       => __('Widget - Instagram Posts block.', 'denali'),
            'render_callback'   => 'denali_acf_block_render_callback',
            // 'enqueue_assets' => 'denali_acf_block_assets_callback',
            'category'          => 'bt-custom-block',
            'icon'              => '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z" /><path d="M19 13H5v-2h14v2z" /></svg>',
...
add_action('acf/init', 'denali_acf_init');

function denali_acf_block_render_callback($block)
{
...
function denali_acf_block_assets_callback($block)
{
