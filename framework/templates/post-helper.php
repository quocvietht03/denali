<?php
/* Count post view. */
if (!function_exists('denali_set_count_view')) {
  function denali_set_count_view()
  {
    $post_id = get_the_ID();

    if (is_single() && !empty($post_id) && !isset($_COOKIE['denali_post_view_' . $post_id])) {
      ...
      /* set cookie. */
      setcookie('denali_post_view_' . $post_id, $post_id, time() * 20, '/');
    }
  }
}
add_action('wp', 'denali_set_count_view');

/* Post count view */
if (!function_exists('denali_get_count_view')) {
  function denali_get_count_view()
  {
    $post_id = get_the_ID();
    $views = get_post_meta($post_id, '_post_count_views', true);

    $views = $views ? $views : 0;
    $label = $views > 1 ? esc_html__('Views', 'denali') : esc_html__('View', 'denali');
    return $views . ' ' . $label;
  }
}

/* Post Reading */
if (!function_exists('denali_reading_time_render')) {
  function denali_reading_time_render()
  {
...
/* Single Post Title */
if (!function_exists('denali_single_post_title_render')) {
  function denali_single_post_title_render()
  {
    ob_start();
?>
...
/* Post Title */
if (!function_exists('denali_post_title_render')) {
  function denali_post_title_render()
  {
    ob_start();
  ?>
    <h3 class="bt-post--title">
...
/* Post Featured */
if (!function_exists('denali_post_featured_render')) {
  function denali_post_featured_render($image_size = 'full')
  {
    ob_start();
...
/* Post Cover Featured */
if (!function_exists('denali_post_cover_featured_render')) {
  function denali_post_cover_featured_render($image_size = 'full')
  {
    ob_start();
    ?>
    <div class="bt-post--featured">
...
/* Post Publish */
if (!function_exists('denali_post_publish_render')) {
  function denali_post_publish_render()
  {
    ob_start();
...
/* Post Short Meta */
if (!function_exists('denali_post_short_meta_render')) {
  function denali_post_short_meta_render()
  {
    ob_start();
...
/* Post Meta */
if (!function_exists('denali_post_meta_render')) {
  function denali_post_meta_render()
  {
    ob_start();
      ...
      <ul class="bt-post--meta">
        <li class="bt-meta bt-meta--author">
          <a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>">
            ...
            <?php echo esc_html__('By', 'denali') . ' ' . get_the_author(); ?>
          </a>
        </li>
        <li class="bt-meta bt-meta--view">
          <a href="<?php echo get_the_permalink(); ?>">
            ...
            <?php echo denali_get_count_view(); ?>
          </a>
        </li>
        ...
        <li class="bt-meta bt-meta--comment">
          <a href="<?php comments_link(); ?>">
            ...
            <?php comments_number(esc_html__('0 Comments', 'denali'), esc_html__('1 Comment', 'denali'), esc_html__('% Comments', 'denali')); ?>
          </a>
        </li>
      </ul>
      <?php
      echo denali_share_render();
      ?>
    </div>
    <?php
    return ob_get_clean();
...
/* Post Category */
if (!function_exists('denali_post_category_render')) {
  function denali_post_category_render()
  {
    $post_id = get_the_ID();
...
/* Post Content */
if (!function_exists('denali_post_content_render')) {
  function denali_post_content_render()
  {
    ...
    ?>
      <div class="bt-post--content">
        ...
        the_content();
        wp_link_pages(array(
          'before' => '<div class="page-links">' . esc_html__('Pages:', 'denali'),
          'after' => '</div>',
        ));
        ?>
      </div>
...
/* Post tag */
if (!function_exists('denali_tags_render')) {
  function denali_tags_render()
  {
    ob_start();
    if (has_tag()) {
    ?>
...
/* Post share */
if (!function_exists('denali_share_render')) {
  function denali_share_render()
  {

    $social_item = array();
    $social_item[] = '<li>
                        <a target="_blank" data-btIcon="fa fa-linkedin" data-toggle="tooltip" title="' . esc_attr__('Linkedin', 'denali') . '" href="https://www.linkedin.com/shareArticle?url=' . get_the_permalink() . '">
                          <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
    ...
    $social_item[] = '<li>
                        <a target="_blank" data-btIcon="fa fa-facebook" data-toggle="tooltip" title="' . esc_attr__('Facebook', 'denali') . '" href="https://www.facebook.com/sharer/sharer.php?u=' . get_the_permalink() . '">
    ...
    $social_item[] = '<li>
                        <a target="_blank" data-btIcon="fa fa-google-plus" data-toggle="tooltip" title="' . esc_attr__('Google Plus', 'denali') . '" href="https://plus.google.com/share?url=' . get_the_permalink() . '">
    ...
    $social_item[] = '<li>
                      <a target="_blank" data-btIcon="fa fa-twitter" data-toggle="tooltip" title="' . esc_attr__('Twitter', 'denali') . '" href="https://twitter.com/share?url=' . get_the_permalink() . '">
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
    ...
    if (is_singular('post') && has_tag()) { ?>
      <div class="bt-post-share">
        <?php if (!empty($social_item)) {
          echo '<span>' . esc_html__('Share: ', 'denali') . '</span><ul>' . implode(' ', $social_item) . '</ul>';
        } ?>
      </div>
    ...
    <?php } elseif (!empty($social_item)) { ?>
      ...
      <div class="bt-post-share">
        <span><?php echo esc_html__('Share: ', 'denali'); ?></span>
...
/* Post Button */
if (!function_exists('denali_post_button_render')) {
  function denali_post_button_render($text)
  { ?>
...
/* Book Now Button */
if (!function_exists('denali_service_button_book_now_render')) {
  function denali_service_button_book_now_render($text)
  {
...
/* Author Icon */
if (!function_exists('denali_author_icon_render')) {
  function denali_author_icon_render()
  { ?>
    <div class="bt-post-author-icon">
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
        <path d="M6.66634 5.83333C6.66634 7.67428 8.15876 9.16667 9.99967 9.16667C11.8406 9.16667 13.333 7.67428 13.333 5.83333C13.333 3.99238 11.8406 2.5 9.99967 2.5C8.15876 2.5 6.66634 3.99238 6.66634 5.83333Z" stroke="#698F65" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M9.99967 11.6667C13.2213 11.6667 15.833 14.2784 15.833 17.5001H4.16634C4.16634 14.2784 6.77801 11.6667 9.99967 11.6667Z" stroke="#698F65" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      </svg>
      <h4 class="bt-post-author-icon--name"> <?php echo esc_html__('By', 'denali') . ' ' . get_the_author(); ?> </h4>
    </div>
  <?php }
}

/* Author */
if (!function_exists('denali_author_render')) {
  function denali_author_render()
  {
...
/* Related posts */
if (!function_exists('denali_related_posts')) {
  function denali_related_posts()
  {
    $post_id = get_the_ID();
    $cat_ids = array();
    ...
    ?>
      <div class="bt-related-posts">
        <div class="bt-related-posts--heading">
          <h4 class="bt-sub"><?php esc_html_e('From The Blog', 'denali'); ?></h4>
          <h2 class="bt-head"><?php esc_html_e('Related News ', 'denali'); ?><span><?php esc_html_e('& Articles', 'denali'); ?></span></h2>
        </div>
...
//Comment Field Order
function denali_comment_fields_custom_order($fields)
{
...
add_filter('comment_form_fields', 'denali_comment_fields_custom_order');

/* Custom comment list */
if (!function_exists('denali_custom_comment')) {
  function denali_custom_comment($comment, $args, $depth)
  {
      ...
      <div class="bt-comment">
        ...
        <div class="bt-content">
          ...
          <?php if ($comment->comment_approved == '0') : ?>
            <em class="comment-awaiting-moderation"><?php esc_html_e('Your comment is awaiting moderation.', 'denali'); ?></em>
          <?php endif; ?>
          <div class="bt-text">
            <?php comment_text(); ?>
          </div>
