...
if( ! function_exists( 'denali_import_pack_scripts' ) ) {
    /**
     * Import pack load scripts
     *
     */
    function denali_import_pack_scripts() {
        ...
        wp_localize_script( 'import-pack-js', 'import_pack_php_data', apply_filters( 'denali/import_pack/localize_script_data', [
            'ajax_url' => admin_url( 'admin-ajax.php' ),
        ] ) );
    }

    add_action( 'admin_enqueue_scripts', 'denali_import_pack_scripts' );
}
