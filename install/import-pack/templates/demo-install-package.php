...
<?php do_action( 'denali/import_pack/demo_install_package/before' ); ?>
...
<div class="ip-package-demo-list">
    ...
    <div class="ip-package-demo-item">
        <div class="preview-image">
            ...
            <div class="actions">
                <a href="<?php echo esc_url( $package_item['url_demo'] ) ?>" target="_blank" class="__action-preview-demo" title="<?php echo esc_attr( 'Preview demo', 'denali' ); ?>">
                    <?php _e( 'Preview', 'denali' ); ?>
                </a>
                <a href="javascript:" class="__action-import-demo" title="<?php echo esc_attr( 'Import demo', 'denali' ); ?>" data-package-id="<?php echo esc_attr( trim( $package_item['package_name'] ) ); ?>">
                    <?php _e( 'Import', 'denali' ); ?>
                </a>
            </div>
        </div>
...
<?php do_action( 'denali/import_pack/demo_install_package/after' ); ?>
